...
enum ToolResultFormatting {
    ...
    static func formatUserTextOutcome(_ rawJSON: String) -> String {
        ...
        appendField("awaited_host_sense", from: outcome, to: &lines)
        appendField("awaited_host_purpose", from: outcome, to: &lines)
        appendField("awaited_host_timeout_ms", from: outcome, to: &lines)
