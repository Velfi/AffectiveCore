...
pub fn tools(allocator: std.mem.Allocator) ![]const Tool {
    const specs = [_]struct { name: []const u8, description: []const u8, schema_json: []const u8 }{
        ...
        .{ .name = "refresh_facial_expression_catalog", .description = "Reload eye and mouth sprite names from avatar.json for facial_expression validation and LLM observations.", .schema_json = "{\"type\":\"object\",\"properties\":{}}" },
        ...
        .{ .name = "emoji_reaction", .description = "Deliver a user emoji reaction to a prior brain utterance.", .schema_json = "{\"type\":\"object\",\"required\":[\"emoji\",\"utterance_text\"],\"properties\":{\"emoji\":{\"type\":\"string\"},\"utterance_text\":{\"type\":\"string\"},\"speaker_label\":{\"type\":\"string\"},\"utterance_event_id\":{\"type\":\"string\"},\"request_id\":{\"type\":\"string\"}}}" },
        ...
        .{ .name = "capability_status_batch", .description = "Record or update status for multiple host capabilities in one persisted write.", .schema_json = "{\"type\":\"object\",\"required\":[\"statuses\"],\"properties\":{\"host_id\":{\"type\":\"string\"},\"statuses\":{\"type\":\"array\",\"items\":{\"type\":\"object\",\"required\":[\"capability_id\"],\"properties\":{\"capability_id\":{\"type\":\"string\"},\"host_id\":{\"type\":\"string\"},\"request_id\":{\"type\":\"string\"},\"permission\":{\"type\":\"string\"},\"availability\":{\"type\":\"string\"},\"quality\":{\"type\":\"number\"},\"reliability\":{\"type\":\"number\"},\"cost\":{\"type\":\"number\"},\"latency_ms\":{\"type\":\"number\"},\"risk\":{\"type\":\"number\"},\"unavailable_reason\":{\"type\":\"string\"}}}}}}" },
