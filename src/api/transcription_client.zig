...
const transcription_port = @import("../core/port_transcription.zig");

pub const TranscriptionService = transcription_port.TranscriptionService;
pub const TranscriptionResult = transcription_port.TranscriptionResult;
pub const TestTranscriptionService = transcription_port.TestTranscriptionService;
